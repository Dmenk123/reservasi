...
class CreateTPembayaran extends Migration
{
    ...
    public function up()
    {
        Schema::create('t_pembayaran', function (Blueprint $table) {
            ...
            $table->decimal('nilai_t_pembayaran', 20); // nilai pembayaran
            $table->string('jenis_t_pembayaran', 100); // cash, cicilan
            $table->decimal('balance_t_pembayaran', 20); // balance uang
            $table->decimal('nominal_cicilan_t_pembayaran', 20)->nullable(); // nilai cicilan (jika jenis cicilan)
            ...
            $table->decimal('nominal_total_t_pembayaran', 20, 2); // jumlah yg telah terbayar
