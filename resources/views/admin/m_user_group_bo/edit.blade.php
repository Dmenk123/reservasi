                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="hidden" id="id_m_user_group_bo" value="{{$old->id_m_user_group_bo}}" class="form-control" name="id_m_user_group_bo">
                                        <input type="text" id="nm_user_group_bo" value="{{$old->nm_user_group_bo}}" class="form-control" name="nm_user_group_bo">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a href="{{route('admin.m_user_group_bo.index')}}" class="btn btn-secondary waves-effect">Back</a>
                                </div>
                            </div>
                        </form>
...
<script>
    $(document).ready( function () {
        ...
        $.ajax({
            url:"{{ route("admin.m_user_group_bo.update") }}",
            method:"POST",
