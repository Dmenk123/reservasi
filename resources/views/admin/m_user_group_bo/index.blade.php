                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header border-bottom">
                        ...
                        <a href="{{route('admin.m_user_group_bo.add')}}" class="btn btn-success float-right"><i data-feather="plus"></i> Add New</a>
                      </div>
...
$(document).ready( function () {
    table = $('#datatable').DataTable({
        ...
        pageLength: 20,
        ajax: {
            url: '{{ route('admin.m_user_group_bo.datatable') }}',
            method: 'post'
        },
        columns: [
            { "width": "5%" },
...
$('#datatable').on('click', '.delete', function(){
    ...
    swal.fire({
        ...
        if(e.value){
            $.ajax({
                url:"{{ route('admin.m_user_group_bo.delete') }}",
                method:"post",
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                data:{id_m_user_group_bo:id_m_user_group_bo},
