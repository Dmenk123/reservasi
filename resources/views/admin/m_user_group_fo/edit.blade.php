                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="hidden" id="id_m_user_group" value="{{$old->id_m_user_group}}" class="form-control" name="id_m_user_group">
                                        <input type="text" id="nm_user_group" value="{{$old->nm_user_group}}" class="form-control" name="nm_user_group">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-select" id="aktif" name="aktif">
                                                <option {{($old->is_active_m_user_group == '1') ? 'selected' : ''}} value="1">Yes</option>
                                                <option {{($old->is_active_m_user_group != '1') ? 'selected' : ''}} value="0">No</option>
                                              </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-select" id="id_m_app" name="id_m_app">
                                                ...
                                                @foreach ($app as $item)
                                                    <option value="{{$item->id_m_app}}" @if ($old->id_m_app == $item->id_m_app) selected @endif>{{$item->nm_m_app}}</option>
                                                @endforeach
                                              </select>
                                        </div>
                                    </div>
...
<script>
    $(document).ready( function () {
        ...
        $.ajax({
            url:"{{ route("admin.m_user_group.update") }}",
            method:"POST",
