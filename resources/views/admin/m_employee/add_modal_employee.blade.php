                        ...
                        <form method="post" id="form">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" id="id_m_employee" class="form-control" name="id_m_employee">
...
{{--
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="nip_m_employee" name="nip_m_employee" class="form-control" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="nm_m_employee" name="nm_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="group_m_employee" name="group_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="cost_center_m_employee" name="cost_center_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="position_m_employee" name="position_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="business_unit_m_employee" name="business_unit_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="department_m_employee" name="department_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="level_3_m_employee" name="level_3_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="level_4_m_employee" name="level_4_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="level_5_m_employee" name="level_5_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="basetown_m_employee" name="basetown_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="gender_m_employee" name="gender_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="age_classification_m_employee" name="age_classification_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="basetown_city_m_employee" name="basetown_city_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="email_m_employee" name="email_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="grade_m_employee" name="grade_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="masa_kerja_m_employee" name="masa_kerja_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="level_2_m_employee" name="level_2_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"   id="level_6_m_employee" name="level_6_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="business_address_m_employee" name="business_address_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="business_address_2_m_employee" name="business_address_2_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  id="postal_code_m_employee" name="postal_code_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="strc_id_m_employee" name="strc_id_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  name="strc_name_m_employee" name="strc_name_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  name="strc_position_m_employee" name="strc_position_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"   name="scope_m_employee" name="scope_m_employee" class="form-control">
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready( function () {
        ...
        $.ajax({
            url:"{{ route("admin.m_employee.save") }}",
            method:"POST",
