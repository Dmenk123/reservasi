    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="mb-1 row">
                ...
                <div class="col-sm-12">
                    <input type="text" id="jam_mulai" class="form-control timepicker" name="jam_mulai" value="">
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="mb-1 row">
                ...
                <div class="col-sm-12">
                    <input type="text" id="jam_akhir" class="form-control timepicker" name="jam_akhir" value="">
                </div>
            </div>
        </div>
