!(function (e, t, s) {
    ...
    i.each(function () {
        ...
        r.wrap('<div class="position-relative"></div>').select2({ dropdownAutoWidth: !0, width: "100%", maximumSelectionLength: 2, dropdownParent: r.parent(), placeholder: "Select maximum 2 items" }),
