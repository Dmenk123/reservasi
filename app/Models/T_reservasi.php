...
class T_reservasi extends Model
{
    ...
    protected $fillable = ['nm_t_reservasi', 'email_t_reservasi', 'kode_t_reservasi', 'telp_t_reservasi', 'id_m_proses', 'hari_t_reservasi', 'jenis_t_reservasi', 'metode_pembayaran_t_reservasi', 'kode_payment_t_reservasi', 'nominal_total'];
